"""
PCA Dimensionality Reduction for Business Features

Purpose:
    Apply Principal Component Analysis (PCA) to the business-logic selected features
    to reduce dimensionality while retaining 95% of the variance.

Input:
    - feature_engineering/output/02_fe_business_encoded.csv
...
def main():
    print("\n" + "=" * 80)
    print("PCA DIMENSIONALITY REDUCTION - BUSINESS FEATURES")
    print("=" * 80)
    
    # Configuration
    input_file = '03 feature_engineering/output/02_fe_business_encoded.csv'
    output_dir = '03 feature_engineering/output'
    prefix = '05_fe_pca_business'
    ...
    if not os.path.exists(input_file):
        ...
        input_file = os.path.join(script_dir, 'output', '02_fe_business_encoded.csv')
