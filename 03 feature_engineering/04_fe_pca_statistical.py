"""
PCA Dimensionality Reduction for Statistical Features

Purpose:
    Apply Principal Component Analysis (PCA) to the statistically selected features
    to reduce dimensionality while retaining 95% of the variance.

Input:
    - feature_engineering/output/01_fe_statistical_encoded.csv
...
def main():
    print("\n" + "=" * 80)
    print("PCA DIMENSIONALITY REDUCTION - STATISTICAL FEATURES")
    print("=" * 80)
    
    # Configuration
    input_file = '03 feature_engineering/output/01_fe_statistical_encoded.csv'
    output_dir = '03 feature_engineering/output'
    prefix = '04_fe_pca_statistical'
    ...
    if not os.path.exists(input_file):
        ...
        input_file = os.path.join(script_dir, 'output', '01_fe_statistical_encoded.csv')
